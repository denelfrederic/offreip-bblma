      ...
      <main className="pt-16 lg:pt-20">
        ...
        <section className="py-24 bg-gradient-to-b from-background to-background/95">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-6">
              Défendez vos <span className="text-gradient">droits</span> efficacement
            </h2>
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              Face à un litige, chaque jour compte. Contactez-nous pour une analyse de votre situation.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                ...
                asChild
              >
                <Link to="/contact">Consultation urgente</Link>
              </Button>
              <Button 
                variant="outline" 
                size="lg" 
